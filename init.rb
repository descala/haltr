  ...
  project_module :haltr do
    permission :free_use,
      { :clients  => [:index, :new, :edit, :create, :update, :destroy],
        ...
        :invoices => [:index, :new, :edit, :create, :update, :destroy, :show, :pdf, :template, :mark_sent, :mark_closed, :mark_not_sent, :destroy_payment, :efactura, :send_invoice, :log, :get_legal],
