...
class PaymentsControllerTest < ActionController::TestCase
  ...
  def test_n19
    ...
    # spaces are relevant
    assert_equal "518077310058C000#{fecha_confeccion}      COMPANY1                                                    12345678                                                                  ", lines[0]
    assert_equal "538077310058C000#{fecha_confeccion}#{@venci}Company1                                12345678901234567890        01                                                                ", lines[1]
    assert_equal "568077310058C000B10317980   SOME NON'ASCII CHARS ?? LONG NAME THAT M208112347612345678900000092568                FRA 08/001                        925,68        ", lines[2]
  end
